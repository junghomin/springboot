...
import jungho.demo.response.ErrorResponse;
...
public class UserController {
    ...
    public ResponseEntity createAccount(@RequestBody @Valid UserDto.Create create,
        ...
        User newAccount = service.createUser(create);
        return new ResponseEntity<>(modelMapper.map(newAccount, UserDto.Response.class),
                HttpStatus.CREATED);
    }
